...
public class WonderlandGame {
    ...
    private void initializeLocations() {
		try {
			...
			// Load exits
			File exitsFile = new File("exits.txt");
			...
			File charactersFile = new File("characters.txt");//file containing all character names,their description and their location
			...
			File actionFile = new File("actions.txt"); //file contains actions data (all controls and instructions)
		...
		//To handle file not found exception
			...
			System.out.println("Error loading game data from files");
		}
	}
